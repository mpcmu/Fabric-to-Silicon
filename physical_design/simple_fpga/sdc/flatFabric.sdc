...
# Logic block
set_max_delay -from $ipin_ffs -to $bleffs -ignore_clock_latency 320
set_max_delay -from $bleffs -to $opin_ffs -ignore_clock_latency 200
set_max_delay -from $ipin_ffs -to $opin_ffs -ignore_clock_latency 520
