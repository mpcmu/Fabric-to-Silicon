...
set ipin_ffs_custmul [get_db insts Tile*custmul*/*pb*IPIN_FF*]
set opin_ffs_custmul [get_db insts Tile*custmul*/*pb*OPIN_FF*]
...
set_max_delay -from $bleffs -to $opin_ffs_clb -ignore_clock_latency 200
set_max_delay -from $ipin_ffs_clb -to $opin_ffs_clb -ignore_clock_latency 410
# Logic Block (custmul)
set_max_delay -from $ipin_ffs_custmul -to $opin_ffs_custmul -ignore_clock_latency 1500
